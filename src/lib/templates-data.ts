import { toMMDD } from "@/lib/schedule-utils";
import { Category, ScheduleType } from "@prisma/client";
    ...
    tasks: [
      {
        ...
        category: "FINANCE",
        scheduleType: "YEARLY",
        scheduleValue: toMMDD(1, 15), // Jan 15
      ...
      },
      {
        ...
        category: "FINANCE",
        scheduleType: "YEARLY",
        scheduleValue: toMMDD(4, 1), // Apr 1
      ...
      },
      {
        ...
        category: "FINANCE",
        scheduleType: "YEARLY",
        scheduleValue: toMMDD(1, 1), // Jan 1
      ...
      },
      {
        ...
        category: "HEALTH",
        scheduleType: "YEARLY",
        scheduleValue: toMMDD(3, 1), // Mar 1
